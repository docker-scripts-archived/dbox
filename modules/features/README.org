...
* Creating features
  ...
  Other features that I have created are: /lbd_disqus/, /lbd_invite/,
  /lbd_sharethis/, /lbd_captcha/, /lbd_janrain/, /lbd_simplenews/,
  /lbd_mass_contact/, /lbd_googleanalytics/, etc.  In order to recreate
  them easily, the script =create-features.sh= can be used. It will
  create a feature for each list of components that is on the
